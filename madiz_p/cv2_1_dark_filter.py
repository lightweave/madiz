...
const_br1 = np.sum(all_brights) / (img_with_trecks.size[0] * img_with_trecks.size[1]) + const1
const_br2 = np.sum(all_brights) / (img_with_trecks.size[0] * img_with_trecks.size[1]) + const2

all_brights2=np.asarray(img_without_trecks , dtype='uint8')
all_brights[all_brights < const_br1] = 0
all_brights2[all_brights2 < const_br1] = 0
